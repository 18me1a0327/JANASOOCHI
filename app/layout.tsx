...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: "/janasoochi-mark-192.png", sizes: "192x192", type: "image/png" },
      { url: "/janasoochi-mark-512.png", sizes: "512x512", type: "image/png" },
    ],
    apple: [{ url: "/janasoochi-mark-192.png", sizes: "192x192" }],
  },
  appleWebApp: {
    capable: true,
