...
export const URDU_BLOCKED='Urdu ingestion is blocked until valid official Urdu source PDFs are authorized.';
...
export function isIngestionLanguageSupported(language:RecordLanguage){return language==='en'||language==='te'}
